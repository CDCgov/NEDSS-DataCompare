package gov.cdc.datacompareapis.security;


import gov.cdc.datacompareapis.exception.DataCompareSecurityException;
...
public class CustomAuthenticationManagerResolver implements AuthenticationManagerResolver<HttpServletRequest> {
    ...
    public AuthenticationManager resolve(HttpServletRequest request){
        ...
        if(introspectionUri ==null || introspectionUri.isEmpty()){
            throw new DataCompareSecurityException("Introspection URI is required");
        }
        if(clientId ==null || clientId.isEmpty() || clientSecret ==null || clientSecret.isEmpty()){
            throw new DataCompareSecurityException("Client ID and Client Secret are required");
        }
